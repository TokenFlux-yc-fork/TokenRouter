...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "health_check_interval_sec", Type: field.TypeInt, Default: 60},
		{Name: "health_check_timeout_sec", Type: field.TypeInt, Default: 10},
		{Name: "health_check_failure_threshold", Type: field.TypeInt, Default: 3},
		{Name: "health_check_success_threshold", Type: field.TypeInt, Default: 2},
		{Name: "health_last_check_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
