...
func init() {
	...
	groupDescBackupPoolRefillThresholdPoints := groupFields[19].Descriptor()
	...
	groupDescAvailabilityProbeConfig := groupFields[31].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[33].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[34].Descriptor()
