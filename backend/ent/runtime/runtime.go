...
func init() {
	...
	groupDescAvailabilityProbeConfig := groupFields[29].Descriptor()
	...
	groupDescHealthCheckEnabled := groupFields[30].Descriptor()
	...
	groupDescHealthCheckIntervalSec := groupFields[31].Descriptor()
	...
	groupDescHealthCheckTimeoutSec := groupFields[32].Descriptor()
	...
	groupDescHealthCheckFailureThreshold := groupFields[33].Descriptor()
	...
	groupDescHealthCheckSuccessThreshold := groupFields[34].Descriptor()
	...
	groupDescHealthConsecutiveFailures := groupFields[36].Descriptor()
	...
	groupDescHealthConsecutiveSuccesses := groupFields[37].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[40].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[41].Descriptor()
