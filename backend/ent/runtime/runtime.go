...
func init() {
	...
	// groupDescBackupPoolRefillThresholdPoints is the schema descriptor for backup_pool_refill_threshold_points field.
	groupDescBackupPoolRefillThresholdPoints := groupFields[23].Descriptor()
	// group.DefaultBackupPoolRefillThresholdPoints holds the default value on creation for the backup_pool_refill_threshold_points field.
	group.DefaultBackupPoolRefillThresholdPoints = groupDescBackupPoolRefillThresholdPoints.Default.(float64)
	...
	groupDescAvailabilityProbeConfig := groupFields[35].Descriptor()
	...
	groupDescHealthCheckEnabled := groupFields[36].Descriptor()
	...
	groupDescHealthCheckIntervalSec := groupFields[37].Descriptor()
	...
	groupDescHealthCheckTimeoutSec := groupFields[38].Descriptor()
	...
	groupDescHealthCheckFailureThreshold := groupFields[39].Descriptor()
	...
	groupDescHealthCheckSuccessThreshold := groupFields[40].Descriptor()
	...
	groupDescHealthConsecutiveFailures := groupFields[42].Descriptor()
	...
	groupDescHealthConsecutiveSuccesses := groupFields[43].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[46].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[47].Descriptor()
