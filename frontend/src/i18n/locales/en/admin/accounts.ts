...
// Accounts
    ...
    openaiOAuthCapacity: {
      ...
      description: 'Estimated remaining capacity across managed OpenAI OAuth accounts',
      generatedAt: 'Generated at {time}',
      refresh: 'Refresh',
      retry: 'Retry',
      loadFailed: 'Failed to load the capacity summary',
      loadFailedHint: 'The current pool estimate is temporarily unavailable.',
      refreshFailed: 'Refresh failed. The previous capacity estimate is still displayed.',
      groupFilter: 'OpenAI group',
      allGroups: 'All groups',
      ungrouped: 'Ungrouped',
      groupOverview: 'Group overview',
      groupName: 'Group',
      groupDisabled: 'Disabled',
      groupTotalsNonAdditive: 'Accounts assigned to multiple groups are counted in each group; group totals are not additive.',
      ...
      estimatedLimit: 'Estimated limit {amount}',
      observedRemaining: 'Observed remaining',
      unobservedLimit: 'Unobserved limit',
      windowCoverage: 'Observed {observed} · Missing {missing} · Stale {stale}',
      accountScope: 'Account scope',
      managedAccounts: 'Managed accounts',
      includedAccounts: 'Included accounts',
      excludedAccounts: 'Excluded accounts',
      shadowAccounts: 'Shadow accounts',
      unknownPlanAccounts: 'Unknown plans',
      unknownPlanWarning: '{count} account(s) have an unknown plan and are excluded from the estimate.',
      unknownPlan: 'Unknown',
      planBreakdown: 'Plan breakdown',
      planBreakdownDescription: 'The 5-hour estimate is {ratio} of each plan\'s primary limit.',
      accountCount: '{count} account(s)',
      limitPerAccount: 'Primary limit / account',
      fiveHourLimitPerAccount: '5-hour limit / account',
      fiveHourWindow: '5-hour window',
      ofLimit: 'of {amount}',
      missingAndStale: 'Missing {missing} · Stale {stale}',
      noPlans: 'No included OpenAI OAuth plans are available.',
      periods: {
