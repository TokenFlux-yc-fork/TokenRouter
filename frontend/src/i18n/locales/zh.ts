export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      syncQoderModels: '同步 Qoder 模型',
      syncQoderModelsLoading: '正在同步 Qoder 模型...',
      syncQoderModelsSuccess: '已同步 Qoder 模型别名：共 {count} 个，变更 {changed} 个',
      syncQoderModelsNoChanges: 'Qoder 模型别名已是最新（共 {count} 个）',
      syncQoderModelsFailed: '同步 Qoder 模型失败',
      syncQoderModelsError: '同步 Qoder 模型失败：{message}',
      dataExport: '导出',
