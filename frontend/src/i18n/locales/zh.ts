export default {
  ...
  marketplace: {
    title: '模型广场',
    subtitle: '卡片展示官方费率与最低分组定价；展开模型后查看各分组容量、倍率与最终计价。',
    backHome: '返回首页',
    ...
    groupsStat: '个分组',
    modelsStat: '个模型',
    availableGroupsStat: '个可用分组',
    autoRefreshing: '自动刷新中',
    modelIdLabel: '模型 ID',
    availableAndTotalGroups: '可用 / 总分组',
    availabilityPercent: '可用性百分比',
    bestGroup: '最优分组',
    sessionUsage: '会话占用',
    rpmUsage: 'RPM 占用',
    fillModelName: '模型 ID',
    pricingRule: '计费规则',
    groupAvailability: '分组可用性',
    openAvailability: '查看模型分组可用性',
    closeAvailability: '关闭分组可用性',
    backToModels: '返回列表',
    viewGroups: '查看分组',
    availabilitySummary: '可用分组',
    copyModelName: '复制模型名',
    callModelId: '调用模型 ID',
    copyModelId: '复制模型 ID',
    ...
    capacityBarSource: '基于后端容量快照',
    capacityUnlimited: '不限',
    rateMultiplier: '分组倍率',
    rateMultiplierValue: '分组倍率{multiplier}',
    officialPriceDiscount: '最低至官方价格的{discount}折',
    officialDiscountValue: '官方价 {discount} 折',
    officialDiscountUnavailable: '未配置官方价折扣',
    officialDiscount: '官方价折扣',
    lowestOfficialDiscount: '最低官方折扣',
    finalBillingPrice: '最终计价',
    groupPricingDetail: '分组计价',
    priceBreakdown: '价格拆解',
    officialRate: '官方费率',
    officialRateShort: '官方',
    finalBillingPriceShort: '最终',
    noLimit: '不限',
    collapseGroups: '收起',
