export default {
  ...
  marketplace: {
    ...
    subtitle: 'Cards show official rates and the lowest group pricing; expand a model to inspect group capacity, multipliers, and final billed pricing.',
    backHome: 'Back Home',
    ...
    groupsStat: 'groups',
    modelsStat: 'models',
    availableGroupsStat: 'available groups',
    autoRefreshing: 'Auto refreshing',
    modelIdLabel: 'Model ID',
    availableAndTotalGroups: 'Available / total groups',
    availabilityPercent: 'Availability percent',
    bestGroup: 'Best group',
    sessionUsage: 'Session usage',
    rpmUsage: 'RPM usage',
    fillModelName: 'Model ID',
    pricingRule: 'Pricing rule',
    groupAvailability: 'Group Availability',
    openAvailability: 'View model group availability',
    closeAvailability: 'Close group availability',
    backToModels: 'Back to list',
    viewGroups: 'View groups',
    availabilitySummary: 'Available groups',
    copyModelName: 'Copy model name',
    callModelId: 'Model ID for requests',
    ...
    rateAndPricing: 'Multiplier / Pricing',
    ...
    capacityBarSource: 'Based on backend capacity snapshot',
    ...
    officialDiscountValue: '{discount}/10 of official price',
    officialDiscountUnavailable: 'Official discount unavailable',
    officialDiscount: 'Official discount',
    lowestOfficialDiscount: 'Lowest official discount',
    finalBillingPrice: 'Final billing price',
    groupPricingDetail: 'Group pricing',
    priceBreakdown: 'Price breakdown',
    officialRate: 'Official rate',
    officialRateShort: 'Official',
    finalBillingPriceShort: 'Final',
    noLimit: 'Unlimited',
