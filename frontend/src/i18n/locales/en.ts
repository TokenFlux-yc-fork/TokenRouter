export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      syncQoderModels: 'Sync Qoder models',
      syncQoderModelsLoading: 'Syncing Qoder models...',
      syncQoderModelsSuccess: 'Qoder model aliases synced: {count} total, {changed} changed',
      syncQoderModelsNoChanges: 'Qoder model aliases are already up to date ({count} total)',
      syncQoderModelsFailed: 'Failed to sync Qoder models',
      syncQoderModelsError: 'Failed to sync Qoder models: {message}',
      dataExport: 'Export',
